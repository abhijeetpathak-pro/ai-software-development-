    ...
    <footer className="bg-black text-white pt-10 sm:pt-12 pb-6 border-t-4 border-[#E31E24]">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-6 lg:gap-8 pb-8">
          ...
          {/* COLUMN 1: INQUIRIES (lg:col-span-3) */}
          <div className="col-span-2 sm:col-span-1 lg:col-span-3 space-y-3">
            ...
            {/* FLAGS GRID */}
            <div className="grid grid-cols-6 gap-1.5 w-full max-w-[180px] pt-1">
              <Link href="/contact/#india" className="block hover:opacity-80" title="India Hub">
                <img src="https://flagcdn.com/w40/in.png" alt="India" className="w-5 h-auto rounded-xs" />
              </Link>
              <Link href="/contact/#dubai" className="block hover:opacity-80" title="UAE Hub">
                <img src="https://flagcdn.com/w40/ae.png" alt="UAE" className="w-5 h-auto rounded-xs" />
              </Link>
              <Link href="/contact/#australia" className="block hover:opacity-80" title="Australia Hub">
                <img src="https://flagcdn.com/w40/au.png" alt="Australia" className="w-5 h-auto rounded-xs" />
              </Link>
              <Link href="/contact/#america" className="block hover:opacity-80" title="USA Hub">
                <img src="https://flagcdn.com/w40/us.png" alt="USA" className="w-5 h-auto rounded-xs" />
              </Link>
              <Link href="/contact/#canada" className="block hover:opacity-80" title="Canada Hub">
                <img src="https://flagcdn.com/w40/ca.png" alt="Canada" className="w-5 h-auto rounded-xs" />
              </Link>
              <Link href="/contact/#singapore" className="block hover:opacity-80" title="Singapore Hub">
                <img src="https://flagcdn.com/w40/sg.png" alt="Singapore" className="w-5 h-auto rounded-xs" />
              </Link>
            </div>
          </div>
        ...
        {/* BOTTOM RIGHTS BAR */}
        <div className="border-t border-gray-800 pt-5 flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Logo */}
          ...
          <div className="flex items-center gap-2.5">
            <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-full overflow-hidden bg-white p-0.5 flex items-center justify-center shadow-md border border-white/20" title="ISO 27001:2022 Certified">
              <Image 
            ...
            <div className="h-10 w-10 sm:h-11 sm:w-11 rounded-full overflow-hidden bg-white p-0.5 flex items-center justify-center shadow-md border border-white/20" title="ISO 9001:2015 Certified">
              <Image 
